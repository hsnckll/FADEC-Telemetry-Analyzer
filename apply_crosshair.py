...
# I will use a regex to replace the entire crosshair_gizle and crosshair_guncelle functions.
...
if new_content == content:
    print('Pattern not found! Regex failed.')
else:
    with codecs.open(filepath, 'w', 'utf-8') as f:
        f.write(new_content)
    print('Successfully updated crosshair functions.')
