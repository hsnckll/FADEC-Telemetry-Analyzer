...
class YuklemeDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.lbl_baslik.setStyleSheet("font-size: 11pt; font-weight: bold; color: #00ffcc;")

        self.lbl_status = QtWidgets.QLabel("Veri dosyaları okunmaya hazırlanıyor...", self)
        self.lbl_status.setStyleSheet("font-size: 10pt; color: #e0e0e0;")
...
class AnaPencere(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):
        ...
        self.crosshair_yazi = pg.TextItem(anchor=(0, 1), color="white", fill=pg.mkBrush(0, 0, 0, 150))
    ...
    def mouseHareketEtti(self, kordinat):
        ...
        if self.analiz_grafigi.sceneBoundingRect().contains(pos):
            ...
            satirlar = [f"<span style='color: white;'>Zaman : {gorsel_saat}</span><br>"]
    ...
    def mouseHareketEtti_Hata(self, kordinat):
        ...
        if self.hata_grafik.sceneBoundingRect().contains(pos):
            ...
            gosterilecek_metin = f"<span style='color: white;'>Zaman : {gorsel_saat}</span><br><br>"
